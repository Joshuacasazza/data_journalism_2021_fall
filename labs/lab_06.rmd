...
international_migration <- read_csv("C://Users/Joshu/OneDrive/Documents/GitHub/data_journalism_2021_fall/labs/data/tabula-md-statistical-handbook.csv", skip=2, col_names=c("city", "july11", "july12", "july13", "july14", "july15", "july16", "july17", "july18", "july19", "total"))
```
...
international_migration_clean <- international_migration %>%
...
**A1** Suburban Washington Region with 62.83%
...
**A2** I wrote data to get the region/city with the largest percentage of migration overall.
...
**A3** Calvert had the biggest percentage change with -.76923077%

```{r}
# Write the code to produce your answer here
international_migration_clean %>%
  mutate(percentage = (july18-july17)/july17) %>%
  arrange(percentage)
```

**Q4** What's your best guess as to why these declines occurred, and in those area in particular?
**A4** All of the top places are down south meaning people may want to be closer to city's like Baltimore and do not want to migrate to places like Calvert, Charles, Southern Maryland Region.
...
```{r}
# Write the code to load the CSV file here
domestic_migration <- read_csv("C://Users/Joshu/OneDrive/Documents/GitHub/data_journalism_2021_fall/labs/data/tabula-md-statistical-handbook-domestic.csv.csv", skip=2, col_names=c("city", "july11", "july12", "july13", "july14", "july15", "july16", "july17", "july18", "july19", "total"))
```
...
```{r}
# Write the code to add the column here
domestic_migration_clean <- domestic_migration %>%
...
**A5** Baltimore City with -62834

```{r}
# Write the code to produce your answer here
domestic_migration_clean %>%
  arrange(total)
```
...
**A7**It's the regions and jurisdictions with a net positive migration for 2017, 2018, and 2019. Frederick stood out to me because of the amount of migration they had. Nobody else on the list hit 2,000 yet they hit over 3,000 in 2018 and 2019.
