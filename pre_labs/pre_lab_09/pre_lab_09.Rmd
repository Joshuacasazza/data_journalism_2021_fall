...
**Answer**195,865 rows, 63 columns
...
**Answer**we renamed ppp_maryland to Maryland_ppp_top_counties.
we grouped the counties together using project_county_names which is the column name.
summarise gave us the total loans for each county.
we arranged the loans in decending order to get the highest total.
made it output only the top 10.

then re-loaded our newly named file
...
**Answer**shows me a big gray block with nothing inside. 
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** Bar graphs with a bunch of names at the bottom grouped up
...
**Answer**The graph is in order from least to greatest. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer**Graph is horizontal and names are clear. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer**The background has changed to being white and not gray. Same horizontal with clear names. 
...
**Answer**background is blue, names are more spread out, bar's are clear and slim
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer**Fix the labels so everything is now clear on what we're seeing. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**We have the data approved and total loans for the date. They are arranged by date.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**Line graph with a ton of spikes.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**Added months to the year's down below to give some more context to what we're seeing. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**Same graph, label below is more clear with the names being tilted so they're clear
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
  geom_line(aes(x=date_approved, y=total_loans)) + 
