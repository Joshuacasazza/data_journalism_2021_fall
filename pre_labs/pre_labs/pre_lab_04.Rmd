...
**Answer**Yes, the column structure is the same
...
**Answer**Error: Can't join on `x$zip` x `y$zip` because of incompatible types. i `x$zip` is of type <character>>. i `y$zip` is of type <double>>. zip is 9 letters while zcta5n is 5 so you need to change the zcta5n to 5 letters to combine.
...
**Answer**It says NA for most of the columns to the far right
...
**Answer**The average is 53836.46 and the median is 20000
...
**Answer**The average is 88140.24 and the median is 20833
...
**Answer**Rural average is 44328.87	and median is 19621. Urban average is 53868.53 and median is	20000.
...
**Answer**Rural average is 73694.14 and median is	20833. urban average is 90911.14 and median is	20833.
