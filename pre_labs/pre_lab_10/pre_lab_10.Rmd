...
**Answer** https://datawrapper.dwcdn.net/ebp7U/1/
...
**Answer** we get the county names and the total number of ppp applications for each. 
...
**Answer** we now only see the county's with number of ppp applications that are greater then six. 
...
**Answer** The column only has 5 digit FIPS codes
...
**Answer** We have combined the two sets of data and now we have all the context with the counties.
...
**Answer** There is no gray at all. No labels or specific numbers either. 
...
**Answer** THe counties are all labeled by names and the numbers have changed.
...
**Answer** https://datawrapper.dwcdn.net/VVbQN/1/
