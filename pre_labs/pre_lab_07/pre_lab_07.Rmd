...
**Answer**Its an Industry Classification Overview featuring NAICS Sectors numbers with a description of what they mean. 
...
**Answer**"The North American Industry Classification System in the Current Employment Statistics Program" source code. There are also links to style sheets inside. 
...
**Answer**html document and the head and body inside with the layout, label, content, etc.
...
**Answer**html code with a head and body along with a few lists. 
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**See the code giving details about the table and data. 
...
**Answer**4 rows that have different fields, positions, and values. 
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**6 different industries with list and list length. 
...
**Answer**gives NAICS SIC-02, 02-07, 07-12, 12-17 with the reference month implemented and date released
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**I get the description and sector for 21 items.
...
**Answer**21 rows with sectors and descriptions. 
...
**Answer**20 rows with sectors and descriptions. 
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**a lot of tables and employee statistics.
...
**Task** Run the following code to read in the html. Briefly describe the output that appears below the codeblock.
**Answer**gives us the head and body. says "begin HEADER"
...
**Answer**we get a caption, head, body, foot with all the details inside. 
...
**Answer**We get the data series with dates and values for each
...
**Answer**Shows Employment, all employees (seasonally adjusted) and the amount for June 2021.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**Mining, Quarrying, and Oil and Gas Extraction data with tables breaking down the data. 
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**Data for construction workers.
...
**Answer**It prints out all the sectors 
```{r}
...
**Answer**List of sectors shows up in the environment 
```{r}
...
**Answer**It says error in sector_list : object 'sector_list' not found
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer**Error in print(sector_name) : object 'sector_name' not found
```{r, error=TRUE}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Answer**1-10 numbers printed out
```{r}
# For loop that includes instructions that refer to a variable that doesn't exist.
for (number in 1:10) {
  print(number)
...
**Answer**20 rows of sectors and a description of them
...
**Answer**numbers 1-20 print out in order.
...
**Answer**Employment, all employees (seasonally adjusted) has	586.7 employees
...
**Task** Run the following code to load table from last chapter. Briefly describe the output that appears below the codeblock.
**Answer**20 rows of sectors and what they are
```{r}
# Define url of page we want to scrape
...
**Answer**It adds a sector_url for each row
...
**Answer**added a sector_xpth_id while keeping the url column
...
**Answer**Got rid of public administration making it only 19 rows now. 
...
**Answer**sector 81	Other Services (except Public Administration) shows with its two id columns
...
**Answer**Gives a url for each of the 19 rows of data
```{r}
...
**Answer**Got a new column with data and now different cells are blank which we havent seen before.
...
**Answer**now just employees and the dates titled by month
...
**Answer**add sector and the two id columns back in
...
**Task** Run the following for loop to clean up tables. Briefly describe the output that appears below the codeblock.
**Answer**we got sector, describtion and employees only
...
**Answer**now all the sectors, employees and description are there for the 19
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**workforce stats by month in 2021 from june to september. 
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**unemployement rate by month
...
**Answer**sector 11 says NA for employees in june
