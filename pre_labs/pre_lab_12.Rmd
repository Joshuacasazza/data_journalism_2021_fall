...
**Answer**Gives us the day, time, county and what dose was taken
...
**Answer**The amount of people vaccinated for county NA.
...
**Answer**There is some pretty low numbers thrown in with a 600+ spike two times.
...
**Answer**vaccines are declining pretty significantly.
...
**Task** Run the following code and put the value of `sub` in the answer.
**Answer**The same graph as before with that generated sentence included.
...
**Answer**Shows each county and the amount of cases over time.
...
**Task** Run the following code and describe what the resulting chart shows
**Answer**changes the structure of the chart and the format. Shows the increase in a consistent way.
...
**Answer**The cases per county in MD as of November 14, 2021.
