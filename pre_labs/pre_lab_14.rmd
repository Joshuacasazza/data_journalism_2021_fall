...
**Answer**Tweets adn all the information surrounding the tweet like who did it.
...
**Answer**Breaks up each word into its own column.
...
**Answer**It shows the top 25 most used words. I found it interesting how many different versions of covid were tweeted, there isn't a clear leader.
...
**Answer**Definietly more interesting. Nobody cares that we use the in tweets, how often we use words like pandemic and vaccine is the interesting part.
...
**Answer**Now shows top words from 2020 and 2021 to see how things like vaccine become a big factor.
...
**Task** Run the following code and describe the results.
**Answer**The top 10 2-word phrases used with the amount of times and their percentage in 2020.
...
**Task** Run the following code and describe the results.
**Answer**the top 10 2-word phrases in 2021.
...
**Task** Run the following code and describe the results.
**Answer**We now seperated the top 10 two-word phrases to be democrats and republicans.
...
**Task** Run the following code and describe the results.
**Answer**Top 10 two-word phrases for republicans. the data is seperated between 20 and 21. has amount and percentage for each.
...
**Answer**Trump is the big one that stands out because there are a ton of positive/negative tweets about him. Trump can be used either way so declairing it as positive is interesting. Even a republican can tweet negative about trump.
