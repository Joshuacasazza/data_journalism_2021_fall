...
**Answer**A list of documents which had various hospital items. 
...
**Answer**a table with 33 columns which has the name, address, city, etc. for hospitals inside the data.
...
**Answer**Now only 72 hospitals that are all in maryland. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**7 rows giving which type of hospitals are in the data and how many. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**Looks like the first 10 features for hospitals in maryland that were general acute care. Gives the city, address, website, etc. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**Uses the longitde-latitude to plot the hospitals around MD.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**Gave me a warning and said the tigris is successfully unpacked
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**18 columns and 3,233 rows of data including things like statefp, countyfp, name, etc. 
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**24 different counties with the statefp of 24
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**a map of MD with all the counties clearly defined 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**Now has all the locations of hospitals in MD
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**dots are now colored based on how many beds they have
...
library(janitor)
library(tidycensus)
census_api_key("d1efadd2c73d7b934cc2559e9d49bee7a7822b20")
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**Shows 10 hospitals with their info like phone number and address
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**22 county's and how many total beds there are in each
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**The estimated population for each county
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**shows 10 counties with the estimated population
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**All county's are in caps
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**10 county's with population and the geometry of each
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**has county, total beds, population, geometry after the join
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**Same thing but NA is now 0
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**mutate to get the number of beds per 100k people and arranged from most to least
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**made a map of md with light blue representing the most beds per 100k
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**changed the color so it's obvious which counties are leading the way
...
**Answer**changed the scale so the lower counties now appear different
